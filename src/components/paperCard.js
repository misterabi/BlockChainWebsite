...
function PaperCard({ icon: Icon, title, description}) {
  ...
  return (
    <Paper style={styles.paper}>
        ...
        <Typography variant="h6" component="h3" style={styles.title}>{title}</Typography>
        <Typography variant="h6" component="h3" style={styles.description}>{description}</Typography>
    </Paper>
  );
}
