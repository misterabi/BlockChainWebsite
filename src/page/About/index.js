...
function About() {
  //Todo: Créer une liste qui générent les cartes
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Excellence, accessibilité mondiale, et authenticité, portées par une équipe dévouée. Redéfinissons la confiance ensemble.
          </Typography>
        </Box>
      </Box>
      {/* Vision Block */}
